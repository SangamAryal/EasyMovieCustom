...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxConstraintlayoutLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>v220alpha13</b> with <b>androidx.constraintlayout:constraintlayout</b> coordinates and
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getV220alpha13() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.constraintlayout.v220alpha13");
        }
     ...
     */
    @Deprecated
    public static class AndroidxLeanbackLibraryAccessors extends SubDependencyFactory {
        private final AndroidxLeanbackPreferenceLibraryAccessors laccForAndroidxLeanbackPreferenceLibraryAccessors = new AndroidxLeanbackPreferenceLibraryAccessors(owner);

        public AndroidxLeanbackLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>v100</b> with <b>androidx.leanback:leanback</b> coordinates and
         * with version reference <b>leanbackVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getV100() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.leanback.v100");
        }

        /**
         * Group of libraries at <b>androidx.leanback.preference</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AndroidxLeanbackPreferenceLibraryAccessors getPreference() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAndroidxLeanbackPreferenceLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class AndroidxLeanbackPreferenceLibraryAccessors extends SubDependencyFactory {

        public AndroidxLeanbackPreferenceLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>v120alpha04</b> with <b>androidx.leanback:leanback-preference</b> coordinates and
         * with version reference <b>leanbackPreferenceVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getV120alpha04() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.leanback.preference.v120alpha04");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>constraintlayoutVersion</b> with value <b>2.2.0-alpha13</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>leanbackPreferenceVersion</b> with value <b>1.2.0-alpha04</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLeanbackPreferenceVersion() { return getVersion("leanbackPreferenceVersion"); }

        /**
         * Version alias <b>leanbackVersion</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLeanbackVersion() { return getVersion("leanbackVersion"); }
        ...
        /**
         * Version alias <b>lifecycleViewmodelKtxVersion</b> with value <b>2.8.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>loggingInterceptor</b> with value <b>3.11.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
